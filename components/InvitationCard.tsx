    ...
    <section className="mx-auto w-full max-w-md px-1 py-3 sm:px-4" aria-labelledby="invitation-title">
      <motion.article animate={{ opacity: 1, y: 0 }} className="overflow-hidden rounded-[2rem] border border-white/80 bg-pastel-pink shadow-pastel" initial={{ opacity: 0, y: reduceMotion ? 0 : 18 }} transition={{ duration: reduceMotion ? 0.01 : 0.45 }}>
        <div className="relative bg-pastel-peach">
          ...
          <p aria-hidden="true" className="absolute inset-x-[17%] bottom-[18.5%] sm:bottom-[17.8%] truncate text-center font-handwriting text-2xl font-semibold leading-none text-pastel-accent drop-shadow-sm sm:text-3xl">
            {name}
          </p>
        </div>
              ...
              {stage === "choice" ? (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button className="group flex h-14 items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-[#FFD8E4] to-[#E8D3FC] border border-[#7C5B8B]/15 px-3 text-sm font-bold text-[#7C5B8B] shadow-[0_5px_16px_rgba(124,91,139,0.18)] transition-all duration-300 ease-out hover:from-[#FFE3F0] hover:to-[#F1E2FF] hover:shadow-[0_8px_25px_-5px_rgba(124,91,139,0.32)] hover:scale-[1.03] active:scale-[0.97]" onClick={() => chooseAttendance("yes")} type="button">
